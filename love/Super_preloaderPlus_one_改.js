...
(function () {
	...
	*/
	...
	var homepage = "https://github.com/machsix/Super-preloader";
	var pkg = {
		version: version,
		author: author,
		license: license,
	...
	const SCRIPT_INFO = {
		...
		version: pkg.version,
		license: pkg.license,
		changelog: "".concat(emoji('1F595'), " Baidu"),
		greasyfork: 'https://greasyfork.org/en/scripts/33522-super-preloaderplus-one-new',
		updateTime: "".concat(now.getFullYear(), "/").concat(now.getMonth() + 1, "/").concat(now.getDate()),
	...
	// Meta for userscript
	"// ==UserScript==\n// @name								"
		.concat(SCRIPT_INFO.name, "\n// @name:zh-CN					")
		.concat(SCRIPT_INFO['name-CN'], "\n// @name:zh-TW					")
		.concat(SCRIPT_INFO['name-CN'], "\n// @namespace						")
		.concat(SCRIPT_INFO.namespace, "\n// @description					Preload and Autopager\n" +
			"// @description:zh-CN		\u9884\u8BFB+\u7FFB\u9875..\u5168\u52A0\u901F\u4F60\u7684\u6D4F\u89C8\u4F53\u9A8C\n" +
			"// @description:zh-TW		\u9884\u8BFB+\u7FFB\u9875..\u5168\u52A0\u901F\u4F60\u7684\u6D4F\u89C8\u4F53\u9A8C\n//" +
			"@author							")
		.concat(SCRIPT_INFO.author, "\n// @contributers				alexolog, heroboy, suchunchen, YFdyh000\n" +
			"// @thanksto						ywzhaiqi, NLF\n" +
			"// @version							")
		.concat(SCRIPT_INFO.version, "\n// @license							")
		.concat(SCRIPT_INFO.license, "\n// @update							")
		.concat(SCRIPT_INFO.updateTime, "\n// @homepageURL					")
		.concat(SCRIPT_INFO.homepageURL, "\n// @downloadURL					")
		.concat(SCRIPT_INFO.downloadURL, "\n// @updateURL						")
		.concat(SCRIPT_INFO.updateURL, "\n// @supportURL					")
		.concat(SCRIPT_INFO.homepageURL, "/issue\n// @contributionURL			https://ko-fi.com/machsix\n" +
			"// @icon								")
		.concat(SCRIPT_INFO.icon, "\n" +
			"// @require							https://cdn.jsdelivr.net/gh/machsix/gm4-polyfill@2.0/gm4-polyfill-mach6-legacy.js\n" +
			"// @grant								GM.getValue\n" +
			"// @grant								GM_getValue\n" +
			"// @grant								GM.setValue\n" +
